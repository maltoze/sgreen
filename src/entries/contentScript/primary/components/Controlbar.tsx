...
export default function Controlbar({ appRoot, onClose }: ControlbarProps) {
  ...
  return (
    <Draggable cancel="button">
      <div className="fixed bottom-4 left-4 z-[2147483646] flex space-x-2 rounded-xl bg-background/50 p-1.5 shadow-[0_1px_2px_0px_rgb(0_0_0_/0.1),0_-1px_2px_-1px_rgb(0_0_0_/0.1)] backdrop-blur">
